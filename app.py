...
if submitted:
    ...
    st.write(
        "The chart below shows how each predictor increased "
        "or decreased the mortality probability generated by "
        "the selected model."
    )

    try:
        with st.spinner(
            "Generating the DALEX explanation..."
        ):
        ...
        st.caption(
            ...
            "mortality probability, while negative contributions "
            "decrease it. These are model explanations and do not "
            "establish causal relationships."
        )

    except Exception:
        st.warning(
            "The prediction was completed, but the DALEX "
...
st.divider()
st.header("Study-Focused AI Assistant")

st.write(
    "Ask questions about the study, model development, "
    "evaluation metrics, predictors or DALEX explanations."
)

st.info(
    "The assistant provides general research information only. "
    "Do not enter names, identification numbers, medical records "
...
if openai_key is None:
    ...
    st.warning(
        "The AI assistant is unavailable because the "
    ...
    assistant_consent = st.checkbox(
        "I understand that this assistant is not a clinical "
        "decision-making service and I will not enter personal "
        "health information."
    )
    ...
    if question:
        ...
        if len(question) > MAX_QUESTION_LENGTH:
            ...
            st.warning(
                f"Please limit the question to "
            ...
            try:
                ...
                # Screen harmful input before generating an answer
                ...
                if moderation.results[0].flagged:
                    ...
                    assistant_answer = (
                        ...
                        "Please ask a question directly related "
                    ...
                    conversation = [
                        ...
                        for message in
                        st.session_state.assistant_messages[-8:]
                    ]
...
"""
    ...
    if st.button("Clear assistant conversation"):
